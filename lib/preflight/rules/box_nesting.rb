    ...
    class BoxNesting
      ...
      def page=(page)
        ...
        if media && bleed && (bleed[2] > media[2] || bleed[3] > media[3])
          @issues = [Issue.new(1, "pdfview", "BleedBox deve ser menor que o MediaBox", self, :page      => page.number,
                                                                               :large_box => "BleedBox",
                                                                               :small_box => "MediaBox")]
        elsif trim && bleed && (trim[2] > bleed[2] || trim[3] > bleed[3])
          @issues = [Issue.new(1, "pdfview", "TrimBox deve ser menor que o BleedBox", self, :page      => page.number,
                                                                              :large_box => "TrimBox",
                                                                              :small_box => "BleedBox")]
        elsif art && bleed && (art[2] > bleed[2] || art[3] > bleed[3])
          @issues = [Issue.new(1, "pdfview", "ArtBox deve ser menor que o BleedBox", self, :page       => page.number,
                                                                             :large_box => "ArtBox",
                                                                             :small_box => "BleedBox")]
        elsif trim && media && (trim[2] > media[2] || trim[3] > media[3])
          @issues = [Issue.new(1, "pdfview", "TrimBox deve ser menor que o MediaBox", self, :page      => page.number,
                                                                              :large_box => "TrimBox",
                                                                              :small_box => "MediaBox")]
        elsif art && media && (art[2] > media[2] || art[3] > media[3])
          @issues = [Issue.new(1, "pdfview", "ArtBox deve ser menor que o MediaBox", self, :page      => page.number,
                                                                             :large_box => "ArtBox",
                                                                             :small_box => "MediaBox")]
        else
          @issues = []
